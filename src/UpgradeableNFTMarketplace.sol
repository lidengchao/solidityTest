...
/**
 * @title UpgradeableNFTMarketplace
 * @dev 可升级的NFT市场合约，使用UUPS代理模式
 * 支持使用ERC1363Token购买NFT
 */
contract UpgradeableNFTMarketplace is Initializable, IERC1363Receiver, OwnableUpgradeable, UUPSUpgradeable {
    // NFT上架信息
    struct Listing {
        address seller;
        uint256 price;
